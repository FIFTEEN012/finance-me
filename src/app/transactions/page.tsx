        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex gap-2.5 w-full md:w-auto">
            <button
              ...
              className="flex-1 md:flex-none font-black text-sm px-6 py-3 rounded-2xl bg-white text-[#2b6c00] border-2 border-[#2b6c00] border-b-4 shadow-[0_3px_0_0_#2b6c00] transform transition-all active:translate-y-[2px] active:border-b-2 hover:bg-slate-50 flex items-center justify-center gap-2"
            >
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="relative flex-grow min-w-[200px] max-w-sm">
            ...
            <input
              ...
              className="w-full pl-10 pr-9 py-2.5 text-sm bg-slate-50 dark:bg-slate-800 border-2 border-slate-200 dark:border-slate-700 rounded-2xl focus:outline-none focus:border-[#58cc02] transition-colors placeholder:text-slate-400 dark:text-white"
            />
            {filter.search && (
              <button
          ...
          <button
            ...
            className={cn(
              ...
              filtersOpen || hasExtra
                ? 'bg-[#58cc02]/10 border-[#58cc02] text-[#2b6c00] dark:text-[#58cc02] shadow-[0_2px_0_0_#58cc02]'
          ...
          >
            ...
            {activeFiltersCount > 0 && (
              <span className="px-2 py-0.5 rounded-full bg-[#58cc02] text-white text-[9px] font-black leading-none flex items-center justify-center">
                {activeFiltersCount}
              </span>
            )}
            ...
            <div className="space-y-1.5">
              ...
              <Select value={filter.categoryId || 'ALL'} onValueChange={(v) => setFilter({ ...filter, categoryId: !v || v === 'ALL' ? '' : v })}>
                <SelectTrigger className={cn(
                  ...
                  filter.categoryId ? 'border-[#58cc02] text-[#2b6c00] dark:text-[#58cc02]' : 'text-slate-500',
                )}>
            ...
            {allTags.length > 0 && (
              <div className="space-y-1.5">
                ...
                <Select value={filter.tag || 'ALL'} onValueChange={(v) => setFilter({ ...filter, tag: !v || v === 'ALL' ? '' : v })}>
                  <SelectTrigger className={cn(
                    'h-10 text-xs w-full bg-slate-50 dark:bg-slate-800 border-2 border-slate-200 dark:border-slate-700 font-bold rounded-xl focus:ring-0',
                    filter.tag ? 'border-[#58cc02] text-[#2b6c00] dark:text-[#58cc02]' : 'text-slate-500',
                  )}>
        ...
        >
          {filtered.length > 0 ? (
            ...
            <div className="flex flex-col items-center justify-center p-12 text-center space-y-4">
              ...
              <button
                onClick={handleOpenAdd}
                className="font-black text-xs px-4 py-2.5 rounded-2xl bg-[#58cc02] text-white border-2 border-[#2b6c00] border-b-4 shadow-[0_2px_0_0_#2b6c00] active:translate-y-[2px] active:border-b-2 hover:bg-[#58cc02] flex items-center gap-1.5 transition-all select-none"
              >
